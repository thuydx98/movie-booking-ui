											...
											<div class="clear_fix">
												<div class="login_left">
													...
													<div class="login_box register_box">
														...
														<span>
															<label for="" class="Lang-LBL0121">
																Ngày sinh
															</label>
															<select id="bd_year" class="input_text" style={{ width: '93px' }}>
															...
															<select id="bd_month" class="input_text" style={{ width: '70px' }}>
															...
															<select id="bd_day" class="input_text" style={{ width: '70px' }}>
																<option value="01" selected="">
																	01
																</option>
																<option value="02">02</option>
														...
														<span>
															<label for="userPhone" class="Lang-LBL0085">
																Số điện thoại
															</label>
													...
													<div class="login_find">
														<span>
															...
															<label for="saveId" class="Lang-LBL5024">
																Lưu ID
															</label>
														</span>
